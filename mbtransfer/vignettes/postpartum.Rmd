...
selective inference through data splitting, following `r Citep("Dai2020FalseDR")`. Roughly, we estimate marginal effects of 
...
taxa. The algorithm in `r Citep("Dai2020FalseDR")` formalizes this intuition in
...
taxa-specific. The result is consistent with the findings of `r Citep("Costello2022LongitudinalDO")`, though. Delivery dramatically remodels the
vaginal microbiome.
