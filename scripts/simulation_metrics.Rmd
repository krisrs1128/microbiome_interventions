...
```{r}
data_paths <- dir_ls(params$data_dir) |>
  path_abs()
...
# library(reticulate)
# library(xgboost)
# sapply(list.files("../mbtransfer/R/", full = T), source)
# sapply(list.files("../tfPaper/R/", full = T), source)
# sapply(list.files("../mdsine/R/", full = T), source)
