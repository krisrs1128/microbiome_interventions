...
interaction_hm(values_df, subject_data, taxa, "Race", -1)
interaction_hm(values_df, subject_data, taxa, "BirthControlYesNo", -1)
interaction_hm(values_df, subject_data, taxa, "bmi_cut", -1)
```
